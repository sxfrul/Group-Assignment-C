    ...
    switch (option) 
    {
        case 1:
            ...
            else 
            {
                ...
                if(quantitySub1>0){
                    printf("\nSports 4 life! \t\t\t\t(%d days)\t\tRM %.2f\n", duraSub1 * quantitySub1, priceSub1 * quantitySub1);
                    quantitySub1=0;
                }
                    
                if(quantitySub2>0){
                    printf("\nMidnight Blockbuster \t\t\t(%d days)\t\tRM %.2f\n", duraSub2 * quantitySub2, priceSub2 * quantitySub2);
                    quantitySub2=0;
                }
                    
                if(quantitySub3>0){
                    printf("\nPremium Movie+ \t\t\t\t(%d days)\t\tRM %.2f\n", duraSub3 * quantitySub3, priceSub3 * quantitySub3);
                    quantitySub3=0;
                }
                
                if(quantityProm1>0){	
                    printf("\nHome of Kids Day - Pass \t\t\t(%d day)\t\tRM %.2f\n", duraProm1 * quantityProm1, priceProm1 * quantityProm1);
                    quantityProm1=0;
                }
                    
                if(quantityProm2>0){
                    printf("\niQIYI Premium VIP Pass \t\t\t(%d days)\t\tRM %.2f\n", duraProm2 * quantityProm2, priceProm2 * quantityProm2);
                    quantityProm2=0;
                }
                    
                if(quantityProm3>0){
                    printf("\nMasterChef US Pass \t\t\t(%d days)\t\tRM %.2f\n", duraProm3 * quantityProm3, priceProm3 * quantityProm3);
                    quantityProm3=0;
                }
